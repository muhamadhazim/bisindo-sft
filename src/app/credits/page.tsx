  ...
  return (
    <LearningScreen eyebrow="SUMBER & LISENSI" title="Belajar dengan sumber yang jelas" description="Sumber materi, izin penggunaan, dan batasan prototype ini dapat ditelusuri di sini." back={{ href: "/learn", label: "Peta belajar" }}>
      <div className="reading-flow">
        <section><h2>Referensi awal Sanjaya</h2><p>Samuel Ady Sanjaya (2024), BISINDO Indonesian Sign Language: Alphabet Image Data, versi 1. DOI 10.17632/ywnjpbcz8m.1. Sembilan gambar dari versi resized milik penerbit disimpan sebagai referensi awal, tanpa perubahan. Halaman Amati dan Praktik sekarang memakai foto Rhio Sutoyo dkk. di bawah.</p><p><a href="https://data.mendeley.com/datasets/ywnjpbcz8m/1" target="_blank" rel="noreferrer">Buka dataset ↗</a> · <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noreferrer">Lisensi CC BY 4.0 ↗</a></p><details><summary>Telusuri setiap gambar</summary><ul className="asset-list">{provenance.map((asset) => <li key={asset.id}><a href={asset.sourceUrl} target="_blank" rel="noreferrer">{asset.symbol} · {asset.sourceFilename} ↗</a></li>)}</ul></details></section>
        ...
        <section><h2>Pelacakan tangan</h2><p>Google MediaPipe Tasks Vision 1.0.1 dan Hand Landmarker float16 v1 menggunakan Apache-2.0. Model mendeteksi titik tangan, bukan kebenaran huruf BISINDO. Pemrosesan berlangsung lokal; koneksi telemetri eksternal diblokir.</p><p><a href="/models/mediapipe/LICENSE">Lisensi dan pemberitahuan pihak ketiga</a> · <a href="/models/mediapipe/provenance.json">Versi dan checksum</a> · <a href="/models/mediapipe/README.md">Batasan pelacakan</a></p></section>
        <section><h2>Materi dan pengenal C/L/O</h2><p>Rhio Sutoyo dkk., BISINDO Hand-Sign Detection Dataset. Model Random Forest dilatih lokal dari 60 gambar C/L/O. Tiga gambar asli yang sama dipakai pada halaman Amati dan Praktik; lisensi MIT. Hasil masih memerlukan uji pengguna dan bukan ukuran kebenaran linguistik.</p><p><a href="https://github.com/rhiosutoyo/Indonesian-Sign-Language-BISINDO-Hand-Sign-Detection-Dataset">Repository dataset</a> · <a href="/assets/signs/rhio-clo/LICENSE">Lisensi dataset</a> · <a href="/assets/signs/rhio-clo/provenance.json">Asal gambar</a> · <a href="/models/rhio-clo-v1/README.md">Catatan model</a></p></section>
        <section><h2>Perangkat lunak</h2><p>ml-random-forest 2.1.0, Next.js, React, dan Tailwind CSS menggunakan lisensi MIT. Dependency dan versi persis dicatat dalam package-lock.json. Tidak ada kode dari repository referensi yang disalin ke aplikasi ini.</p></section>
      </div>
    </LearningScreen>
  );
}
