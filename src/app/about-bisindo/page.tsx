  ...
  return (
    <LearningScreen eyebrow="SEBELUM MULAI" title="Kenalan dengan BISINDO" description="Kita mulai dari alfabet, sambil mengenal konteks bahasa dan cara berlatihnya." back={{ href: "/", label: "Beranda" }}>
      <div className="reading-flow">
        ...
        <section><h2>Belajar bentuk alfabet A–Z</h2><p>Materi memakai karakter tangan orisinal dengan acuan pose Rhio Sutoyo dkk. dan pembanding Sanjaya. Model A–Z mencoba bentuk diam dari contoh, bukan gerakan lengkap. Contohnya sudah dicocokkan dengan sumber; belum ada penilaian khusus dari validator manusia untuk aplikasi ini. Region referensi belum diketahui.</p></section>
