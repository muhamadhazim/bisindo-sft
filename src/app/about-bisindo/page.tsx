  ...
  return (
    <LearningScreen eyebrow="SEBELUM MULAI" title="Kenalan dengan BISINDO" description="Kita mulai dari alfabet, sambil mengenal konteks bahasa dan cara berlatihnya." back={{ href: "/", label: "Beranda" }}>
      <div className="reading-flow">
        ...
        <section><h2>Mulai dari C, L, dan O</h2><p>Materi awal memakai foto dari dataset Rhio Sutoyo dkk. yang juga digunakan untuk pengenal C/L/O. Contohnya sudah dicocokkan dengan sumber; belum ada penilaian khusus dari validator manusia untuk aplikasi ini. Region referensi belum diketahui.</p></section>
