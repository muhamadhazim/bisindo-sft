...
export function CertificateCenter() {
  ...
  return <LearningScreen eyebrow="E-CERTIFICATE" title="Sertifikat perjalananmu" description="Sertifikat ini menyatakan penyelesaian pembelajaran alfabet di aplikasi HANDSIGN, bukan uji kemahiran BISINDO." back={{ href: "/profile", label: "Progresku" }}>
