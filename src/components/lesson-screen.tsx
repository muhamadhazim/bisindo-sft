...
export function LessonScreen({ eyebrow,title,description,back,children }: {
  ...
  return <div className="shell lesson-workspace">
    ...
    <aside className="lesson-guide" aria-label="Panduan belajar">
      ...
      <div className="guide-card"><span className="feature-icon mint"><Icon name="leaf" /></span><h2>Amati, lalu coba</h2><p>Perhatikan bentuk dan arah tangan pada foto. Buka gambar ukuran penuh untuk melihat lebih jelas.</p></div>
